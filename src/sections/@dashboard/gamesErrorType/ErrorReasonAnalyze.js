...
// sections
import ErrorTableRow from '../table/TableRow';
import ErrorTableToolbar from '../table/TableToolbar';
// _mock_
import { _errorRecord } from '../../../_mock';
...
export default function ErrorReasonAnalyze() {
  const {
    dense,
    page,
    order,
  ...
  const [tableData, setTableData] = useState(_errorRecord);
